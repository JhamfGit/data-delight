 ...
 * @param {{ q?: string, status?: string, proyecto?: string, centro_operacion?: string, user_id?: number|string, page?: number|string, pageSize?: number|string }} filters
 */
export function buildRegistrosListQuery(actor, filters = {}) {
  const { q, status, proyecto, centro_operacion, user_id, page, pageSize } = filters;
